...
% algoritmo_genetico([4439, 4440, 4441, 4442, 4443], LOrdemDeEntregas,LOrdemDeArmazens,ListaCarregamentosArmazem,ListaQuantidadesCarregamento,ListaTemposCarregamentoArmazem,Custo).

algoritmo_genetico(ListaEntregas,LOrdemDeEntregas,LOrdemDeArmazens,ListaCarregamentosArmazem,ListaQuantidadesCarregamento,ListaTemposCarregamentoArmazem,Custo) :-
    gera_com_tempo_limitado(ListaEntregas, LOrdemDeEntregas),
...
procurar_entrega(ListaEntregas):-
    nth1(2, ListaEntregas, X),
    entrega(X,_,P,_,_,_),
    format(user_output,'Test: ~p~n',P).
